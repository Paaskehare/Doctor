...
from doctor.irclib import SimpleIRCClient
from doctor.irclib import nm_to_n, irc_lower, all_events
from doctor.irclib import parse_channel_modes, is_channel
from doctor.irclib import ServerConnectionError
...
"""
    def __init__(self, server_list, nickname, realname, password="", sslsock=False, reconnection_interval=60):
